...
import bg.tu_varna.sit.f24621690.commands.command.order.CloseOrderCommand;
import bg.tu_varna.sit.f24621690.commands.factory.CommandFactory;

/**
 * Фабрика за създаване и изпълнение на командата за приключване на поръчка (closeorder).
 * Отговаря за валидацията на входа преди маркирането на сметката като платена (PAID).
 */

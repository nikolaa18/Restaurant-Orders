...
import bg.tu_varna.sit.f24621690.commands.command.order.ShowOrderCommand;
import bg.tu_varna.sit.f24621690.commands.factory.CommandFactory;

/**
 * Фабрика за създаване и изпълнение на командата за детайлен преглед на поръчка (showorder).
 * Подава валидираното ID на поръчката към командата за визуализация на натрупаната сметка.
 */
